...
test("TestCase16", async ({ page }) => {
    ...
    // await page.pause()//this one way to do debugging, but it is not recommended to use in production code. It is only for debugging purpose.
